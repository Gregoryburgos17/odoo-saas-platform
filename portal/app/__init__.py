"""
Customer Portal Flask Application Factory
"""
import os
import logging
...
def create_app(config_name: str = None) -> Flask:
    ...
    logger.info(f"Customer Portal initialized in {config_name or 'default'} mode")
...
def configure_app(app: Flask, config_name: str = None):
    ...
    # Trial configuration
    app.config['DEFAULT_TRIAL_DAYS'] = int(os.getenv('DEFAULT_TRIAL_DAYS', '14'))
...
def register_blueprints(app: Flask):
    ...
    from .api import auth_bp, health_bp, tenants_bp, billing_bp, support_bp
        ...
        plans_data = [
            {
                ...
                'allowed_modules': ['sale', 'purchase', 'inventory', 'crm'],
                'trial_days': 14,
                'sort_order': 1,
            },
            {
                ...
                'allowed_modules': ['sale', 'purchase', 'inventory', 'crm', 'project', 'hr', 'accounting'],
                'trial_days': 14,
                'sort_order': 2,
            },
            {
        ...
        with session_scope() as session:
            for plan_data in plans_data:
                ...
                if not existing:
                    ...
                    click.echo(f"Plan already exists: {plan_data['name']}")
